...
"msgtype": "actionCard",
"actionCard": {
"title":"GrayLog节点:【Node2】的graylog-server服务已启动,节点进入【<font color=#FF0000>BACKUP </font> 】状态!",
"text":"
##### GrayLog节点:【Node2】的graylog-server服务已启动,节点进入【<font color=#FF0000>BACKUP </font> 】状态! \n
